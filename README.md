...
3. `yarn prod`
4. Open a browser to [`localhost:8080`](localhost:8080)
...
6. Open a browser to [`localhost:8080`](localhost:8080)

Optional steps:
- `brew install jenv` if you want to run and test on multiple JDK versions and need an easy way to switch between them.
- You can find additional information courtesy of shadow-cljs a [`http://localhost:9630/inspect`](http://localhost:9630/inspect)
